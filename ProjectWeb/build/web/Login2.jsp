<%-- 
    Document   : Login2
    Created on : Mar 29, 2021, 8:56:26 PM
    Author     : t.manh
--%>
        ...
        <div class="container" id="container">
            <div class="form-container sign-up-container">
                <form action="register" method="POST">
                    ...
                    <input type="password" class="input" placeholder="Password" name="password" id="pass" value=""/>
                    <input type="password" class="input" placeholder="Re-Password" id="respass" name="repassword" value=""/>
